...
SYS_MODULE_OBJ DRV_SPI0_Initialize(void)
{
    ...
    qInitData.maxElements = 2; //Queue size
...
DRV_SPI_BUFFER_HANDLE DRV_SPI0_BufferAddWriteReadNew ( void *txBuffer, size_t txSize, void *rxBuffer, size_t rxSize, DRV_SPI_BUFFER_EVENT_HANDLER completeCB, void * context )
{
    return DRV_SPI0_BufferAddWriteRead2(txBuffer, txSize, rxBuffer, rxSize, completeCB, context, NULL);
}
...
DRV_SPI_BUFFER_HANDLE DRV_SPI1_BufferAddWriteReadNew ( void *txBuffer, size_t txSize, void *rxBuffer, size_t rxSize, DRV_SPI_BUFFER_EVENT_HANDLER completeCB, void * context )
{
    return DRV_SPI1_BufferAddWriteRead2(txBuffer, txSize, rxBuffer, rxSize, completeCB, context, NULL);
}
