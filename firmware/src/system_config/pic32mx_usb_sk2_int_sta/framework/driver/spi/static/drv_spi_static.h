...
/* This API name was present in the old static driver which is maintained for the compatibility.
   So, giving a new name for the new static driver which is taken care while mapping */
